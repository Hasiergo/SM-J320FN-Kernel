...
#define LOAD_FREQ	(5*HZ+1)	/* 4.61 sec intervals */
#define EXP_1		1884		/* 1/exp(4.61sec/1min) as fixed-point */
#define EXP_5		2014		/* 1/exp(4.61sec/5min) */
#define EXP_15		2037		/* 1/exp(4.61sec/15min) */
